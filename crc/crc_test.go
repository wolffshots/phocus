...
func TestVerify(t *testing.T) {
	inputs := []string{"QID\xd6\xea\r", "QPGS0\x3F\xDA\r", "QPGS1\x2F\xFB\r", "QPGS4\x3F\xDA\r", "QPGS2\x2F\xFB\r", "\x00\x00\r", "1 92932004102443 B 00 237.0 50.01 000.0 00.00 0483 0387 009 51.1 000 069 020.4 000 00942 00792 007 00000010 1 1 060 080 10 00.0 006\xf2\x2d\r"}
	wants := []bool{true, true, true, false, false, false, true}
	for index, input := range inputs {
		result := Verify(input)
		assert.Equal(t, wants[index], result)
	}
