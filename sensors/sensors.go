...
var sensors = []Sensor{
	...
	{
		SensorTopic:   "homeassistant/sensor/phocus/error_time/config",
		UniqueId:      "phocus_error_time",
		Unit:          units.None,
		StateClass:    state_classes.None,
		DeviceClass:   device_classes.Timestamp,
		Name:          "Error Time",
		ValueTemplate: "",
		StateTopic:    "phocus/stats/error_time",
		Icon:          "mdi:clock",
	},
	{
		SensorTopic:   "homeassistant/sensor/phocus/health_counter/config",
		UniqueId:      "phocus_health_counter",
		Unit:          units.None,
		StateClass:    state_classes.None,
		DeviceClass:   device_classes.None,
		Name:          "Health Counter",
		ValueTemplate: "",
		StateTopic:    "phocus/stats/health_counter",
		Icon:          "mdi:clock",
	},
	{
		SensorTopic:   "homeassistant/sensor/phocus/uptime_seconds/config",
		UniqueId:      "phocus_uptime_seconds",
		Unit:          units.None,
		StateClass:    state_classes.None,
		DeviceClass:   device_classes.None,
		Name:          "Uptime Seconds",
		ValueTemplate: "",
		StateTopic:    "phocus/stats/uptime_seconds",
		Icon:          "mdi:clock",
	},
	{
		SensorTopic:   "homeassistant/sensor/phocus/version/config",
